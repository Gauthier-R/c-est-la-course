          ...
          children: [
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Semaine Actuelle', style: AppTheme.titleMedium),
                        Text(_formatWeekRange(weekStart), style: AppTheme.labelSmall.copyWith(color: AppColors.textSecondary)),
                      ],
                    ),
                  ),
                  IconButton(
                  ...
                  IconButton(
                    ...
                    onPressed: () => showDialog(context: context, builder: (_) => EditWeeklyListDialog(weekStart: weekStart)),
            ...
            Expanded(
              child: Container(
                ...
                child: WeeklyIngredientList(weekStart: weekStart),
              ),
            ),
          ],
        ),
