          ...
          children: [
              ...
              children: [
                IconButton(
                  icon: Icon(Icons.arrow_back_ios_new_rounded,
                      color: Colors.white, size: ResponsiveHelper.widthPercent(context, 0.05)),
                ...
                IconButton(
                  icon: Icon(Icons.add,
                      color: Colors.white, size: ResponsiveHelper.widthPercent(context, 0.06)),
                  onPressed: () => _showAddIngredientDialog(context, currentWeekStart),
                ),
                IconButton(
                  icon:
                      Icon(Icons.edit, color: Colors.white, size: ResponsiveHelper.widthPercent(context, 0.05)),
                  onPressed: () {
                    showDialog(
                      context: context,
                      builder: (_) => EditWeeklyListDialog(weekStart: currentWeekStart),
                    );
                  },
                ),
              ],
            ...
            Expanded(
              child: Container(
                ...
                child: WeeklyIngredientList(weekStart: currentWeekStart),
              ),
            ),
          ],
        ),
